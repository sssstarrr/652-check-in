...
class SettingsDialog(QDialog):
    ...
    def _load(self) -> None:
        ...
        auto_time = QTime.fromString(str(self.settings.get("auto_checkin_time") or "07:30"), "HH:mm")
        self.auto_checkin_time_edit.setTime(auto_time if auto_time.isValid() else QTime(7, 30))
